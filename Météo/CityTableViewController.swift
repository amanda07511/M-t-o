...
class CityTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.titleLabel.text = city.name + " "+city.temp.description
        cell.minLabel.text = "min: "+city.tempmin.description
        cell.maxLabel.text = "max: "+city.tempmax.description
        cell.pressLabel.text = city.presure.description
        cell.humLabel.text = city.humidity.description
    ...
    */
    ...
    private func loadSampleCities() {
        ...
        guard let city1 = City(name: "Grenoble", wMain: "Clear", wDescription: "Clear Sky", temp: 12.5, tempmax: 19, tempmin: 5, presure: 95.5, humidity: 12.8, icon: "01d") else {
